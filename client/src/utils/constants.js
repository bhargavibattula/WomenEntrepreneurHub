...
export const UPDATE_EVENT_BY_ID = 'api/event/update-event'
...
export const DELETE_JOB_BY_ID = 'api/job/delete-job'
export const UPDATE_JOB_BY_ID = 'api/job/update-job'

export const DELETE_BUSINESS_BY_ID = 'api/business/deleteBusiness'
export const UPDATE_BUSINESS_BY_ID = 'api/business/updateBusiness'

export const DELETE_RESOURCE_BY_ID = 'api/resource'
export const UPDATE_RESOURCE_BY_ID = 'api/resource'
